...
def ThreatStack(api_key=None, org_id=None, user_id=None, api_version=DEFAULT_VERSION, timeout=120):
    ...
    return client(api_key=api_key, org_id=org_id, user_id=user_id, timeout=timeout)
