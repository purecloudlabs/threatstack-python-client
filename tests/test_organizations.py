...
def test_list_organizations():
    httpretty.register_uri(httpretty.GET, "https://app.threatstack.com/api/v1/organizations",
...
def test_get_organization_users():
    httpretty.register_uri(httpretty.GET, "https://app.threatstack.com/api/v1/organizations/acbd18db4cc2f85cedef654fccc4a4dG8/users",
                           content_type="application/json",
                          body='[ \
                                    { \
