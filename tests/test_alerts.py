...
def test_list_alerts():
    responses.add(responses.GET, "https://app.threatstack.com/api/v1/alerts",
...
@responses.activate
def test_get_alert():
    responses.add(responses.GET, "https://app.threatstack.com/api/v1/alerts/52ebb55fdf5fb93e710002ba",
                  content_type="application/json",
                  body='{ \
                            "active": true, \
                            "agent_id": "52eafd46e5777f3a26000008", \
